<template>
  <div ref="scroll" class="ratings">
    <div class="ratings-content">
      ...
      <split></split>
      <ratingselect :selectType="selectType" :desc="desc" :ratings="ratings"
                    @EVENT_SELECT="onSelected"
                    @EVENT_TOGGLE="onToggle"></ratingselect>
